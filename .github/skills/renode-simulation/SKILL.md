...
description: 'Guide for running and troubleshooting the Renode dual-board simulation. Use when: starting the simulation, configuring Renode, understanding the UART Hub setup, working with discovery_dual.resc, using robot mode XML-RPC commands, inspecting GPIO or UART state in Renode, or debugging inter-board communication.'
---

# Renode Simulation – Dual STM32F4 Discovery Board Setup
